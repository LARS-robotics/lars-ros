...
int main(int argc, char **argv)
{
	...
	ofstream myfile_1("/home/jjin/catkin_ws/src/jingfu/data/robot_1.txt",ios::out | ios::binary);
	ofstream myfile_2("/home/jjin/catkin_ws/src/jingfu/data/robot_2.txt",ios::out | ios::binary);
	ofstream myfile_3("/home/jjin/catkin_ws/src/jingfu/data/robot_3.txt",ios::out | ios::binary);
	ofstream myfile_4("/home/jjin/catkin_ws/src/jingfu/data/quad.txt",ios::out | ios::binary);
	...
	while (ros::ok())
	{
		...
		virtualGoal(0,0) = q10_v.x; virtualGoal(0,1) = q10_v.y; virtualGoal(0,2) = q10_v.h;
		virtualGoal(1,0) = q20_v.x; virtualGoal(1,1) = q20_v.y; virtualGoal(1,2) = q20_v.h;
		virtualGoal(2,0) = q30_v.x; virtualGoal(2,1) = q30_v.y; virtualGoal(2,2) = q30_v.h;
